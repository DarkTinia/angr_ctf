...
def main(argv):
  ...
  if simulation.found:
    ...
    solution0 = solution_state.solver.eval(stored_solutions0[0])
    solution1 = solution_state.solver.eval(stored_solutions0[1])

    print("Solution is: {0} {1}".format(solution0, solution1))
  else:
